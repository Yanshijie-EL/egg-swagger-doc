    ...
    for (let obj of funcBundler) {
      ...
      for (let req of obj.routers) {
        ...
        if (instance.prototype) {
          ...
          // app.logger.info('RouterRegister-controller: ' + JSON.stringify(controller));
          const control = convertControllerPath(instance.prototype.pathName, controller);
          // app.logger.info('RouterRegister-control: ' + JSON.stringify(control));
          // app.logger.info('RouterRegister-control[req.func]: ' + control[req.func]);
